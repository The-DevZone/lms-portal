...
// This function returns a HeroSection component
const HeroSection = () => {

  // Return a div with a gradient background and text centered
  return (
    <div className="relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center">
      {/* Create a max-width container for the content */}
      <div className="max-w-3xl mx-auto">
        {/* Create a heading for the HeroSection */}
        <h1 className="text-white text-4xl font-bold mb-4">
          Find the Best Courses for You
        </h1>
        {/* Create a paragraph for the HeroSection */}
        <p className="text-gray-200 dark:text-gray-400 mb-8">
          Discover, Learn, and Upskill with our wide range of courses
        </p>

        {/* Create a form for the HeroSection */}
       ...
       {/* Create a button for the HeroSection */}
